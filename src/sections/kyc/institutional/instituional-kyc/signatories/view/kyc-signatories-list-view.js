...
export default function SignatoriesListView({
    ...
    }, [dataInitializedSteps, loading, signatories]);
    ...
    useEffect(() => {
        ...
        if (signatories.length >= 1 && sessionStorage.getItem(getUboNextConfirmedKey(merchantId)) === 'true') {
            setActiveStepId();
        }
    }, [loading, setActiveStepId, signatories]);
